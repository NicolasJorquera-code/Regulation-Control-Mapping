...
def _render_risk_inventory_tab() -> None:
    """Risk Inventory Builder tab: end-to-end risk inventory experience."""
    from controlnexus.ui.risk_inventory_tab import render_risk_inventory_tab

    render_risk_inventory_tab()
